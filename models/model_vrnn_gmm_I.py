...
"""VRNN-GMM-I 
modification of the VRNN-GMM without the conditional prior. 
VRNN-GMM uses zt~N(mu,sigma) with [mu,sigma]=NN(h[t])
VRNN-GMM-I uses zt~N(0,1)"""


class VRNN_GMM_I(nn.Module):
    def __init__(self, param, device, bias=False):
        super(VRNN_GMM_I, self).__init__()
