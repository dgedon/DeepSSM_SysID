...
class DynamicModel(nn.Module):
    def __init__(self, model, num_inputs, num_outputs, options, normalizer_input=None, normalizer_output=None,
        ...
        if model == 'VRNN-Gauss':
            self.m = VRNN_Gauss(model_options, options['device'])  # , normalizer_u, normalizer_y)
    ...
    def generate(self, u, y=None):
        ...
        y_sample = y_sample.detach()
        y_sample_mu = y_sample_mu.detach()
        y_sample_sigma = y_sample_sigma.detach()
