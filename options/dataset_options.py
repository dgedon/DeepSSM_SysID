...
def get_dataset_options(dataset_name):
    ...
    if dataset_name == 'cascaded_tank':
        ...
        dataset_parser.add_argument('--y_dim', type=int, default=1, help='dimension of y')
        dataset_parser.add_argument('--u_dim', type=int, default=1, help='dimension of u')
        dataset_parser.add_argument('--seq_len_train', type=int, default=512, help='training sequence length')
        dataset_parser.add_argument('--seq_len_test', type=int, default=512, help='test sequence length')
        dataset_parser.add_argument('--seq_len_val', type=int, default=512, help='validation sequence length')  # 512
        dataset_options = dataset_parser.parse_args()
